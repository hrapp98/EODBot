        ...
        if request.form.get('payload'):
            ...
            if payload['type'] == 'view_submission':
                ...
                report_data = {
                    ...
                    'tools_used':
                    values.get('tools_block', {}).get('tools_input', {}).get('value', ''),
                    'help_needed':
                    values.get('help_block', {}).get('help_input', {}).get('value', ''),
                    'client_feedback':
                    values.get('client_feedback_block', {}).get('client_feedback_input', {}).get('value', '')
                }
